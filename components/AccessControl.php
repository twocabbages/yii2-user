...
class AccessControl extends ActionFilter
{
	...
	public function beforeAction($action)
	{
		...
		if ($controller->module !== null) {
			if ($user->can($this->getItemName($controller->module) . $this->separator . '*', $this->params)) {
				return true;
			}
		}
		if ($user->can($this->getItemName($controller) . $this->separator . '*', $this->params)) {
			return true;
		}

		if ($user->can($itemName = $this->getItemName($action), $this->params)) {
			return true;
		}
