...
$this->title = \Yii::t('user.common', 'Update Profile');
$this->params['breadcrumbs'][] = ['label' => Yii::t('user.common', 'Profile'), 'url' => ['view']];
...
<div class="panel panel-primary">
	...
	<div class="panel-footer">
		<?= Html::submitButton(Yii::t('user.common', $model->isNewRecord ? 'Create' : 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
	</div>
</div>
<?php ActiveForm::end(); ?>
